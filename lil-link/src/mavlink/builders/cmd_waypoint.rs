use mavlink::ardupilotmega::{
    PositionTargetTypemask, COMMAND_LONG_DATA, SET_POSITION_TARGET_LOCAL_NED_DATA,
};

use crate::common::types::{pose_ned::QuadPoseNED, request_land::QuadLandRequest};

pub fn mavlink_build_cmd_waypoint_message(
    desired_pose: QuadPoseNED,
) -> Option<mavlink::ardupilotmega::MavMessage> {
    let land_cmd = mavlink::ardupilotmega::MavMessage::SET_POSITION_TARGET_LOCAL_NED(
