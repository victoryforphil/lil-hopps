...
impl QuadSensorStatus{
    pub fn get_map(&self) -> HashMap<String, bool>{
        ...
        map.insert("MAV_SYS_STATUS_SENSOR_ABSOLUTE_PRESSURE".to_string(), self.abs_pressure);
        map.insert("MAV_SYS_STATUS_SENSOR_DIFFERENTIAL_PRESSURE".to_string(), self.diff_pressure);
        map.insert("MAV_SYS_STATUS_SENSOR_GPS".to_string(), self.gps);
        map.insert("MAV_SYS_STATUS_SENSOR_OPTICAL_FLOW".to_string(), self.optical_flow);
        map.insert("MAV_SYS_STATUS_SENSOR_VISION_POSITION".to_string(), self.vision_position);
        map.insert("MAV_SYS_STATUS_SENSOR_LASER_POSITION".to_string(), self.laser_position);
        map.insert("MAV_SYS_STATUS_SENSOR_EXTERNAL_GROUND_TRUTH".to_string(), self.external_ground_truth);
        map.insert("MAV_SYS_STATUS_SENSOR_ANGULAR_RATE_CONTROL".to_string(), self.rate_control);
        map.insert("MAV_SYS_STATUS_SENSOR_ATTITUDE_STABILIZATION".to_string(), self.attitude_stabilization);
        map.insert("MAV_SYS_STATUS_SENSOR_YAW_POSITION".to_string(), self.yaw_position);
        map.insert("MAV_SYS_STATUS_SENSOR_Z_ALTITUDE_CONTROL".to_string(), self.altitude_control);
        map.insert("MAV_SYS_STATUS_SENSOR_XY_POSITION_CONTROL".to_string(), self.xy_position_control);
        map.insert("MAV_SYS_STATUS_SENSOR_MOTOR_OUTPUTS".to_string(), self.motor_control);
        map.insert("MAV_SYS_STATUS_SENSOR_RC_RECEIVER".to_string(), self.rc_receiver);
        ...
        map.insert("MAV_SYS_STATUS_REVERSE_MOTOR".to_string(), self.reverse_motor);
        map.insert("MAV_SYS_STATUS_LOGGING".to_string(), self.logging);
        map.insert("MAV_SYS_STATUS_SENSOR_BATTERY".to_string(), self.battery);
        map.insert("MAV_SYS_STATUS_SENSOR_PROXIMITY".to_string(), self.proximity);
        ...
        map.insert("MAV_SYS_STATUS_OBSTACLE_AVOIDANCE".to_string(), self.obstacle_avoidance);
        map.insert("MAV_SYS_STATUS_SENSOR_PROPULSION".to_string(), self.propulsion);
