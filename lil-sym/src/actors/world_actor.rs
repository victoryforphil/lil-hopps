...
impl SimActor<WorldActorResult> for WorldActor{
    ...
    fn step(&mut self, context: crate::SimContextHandle, state: &crate::SimulationState, t: &lil_broker::Timestamp, dt: &lil_broker::Timestamp) -> Result<WorldActorResult, anyhow::Error> {
